...
![ProSports Demo GIF](asset/imges/demo.gif)
---
...
* **Build Tool:** [Vite](https://vitejs.dev/) - Used for the development server and bundling.
...
4.  **‼️ IMPORTANT: Add Your API Key**
    ...
    This project requires a valid API key from [API-Football](https://www.api-football.com/) to function. The API key is loaded securely via an environment variable.
...
6.  **Open in your browser:**
    Your terminal will show a local URL. Open it in your browser (e.g., `http://localhost:5173/`).
